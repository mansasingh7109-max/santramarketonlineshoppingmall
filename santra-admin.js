  ...
  const Admin = {
    ...
    create(){
      ...
      setInterval(()=>{
        ...
        const cart=JSON.parse(localStorage.getItem(CART_KEY)||'[]'); // <-- FIXED
        document.getElementById('sa-cart').textContent=cart.reduce((s,i)=>s+(i.qty||1),0);
      },1000);
    },
    toggle(){
