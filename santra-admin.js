// santra-admin.js - Separate Admin Panel
(function(){
  if(window.SantraAdminLoaded) return;
  window.SantraAdminLoaded=true;
  console.log('🛠️ Santra Admin Loaded');
  ...
  if(location.search.includes('admin=1')) setTimeout(()=>Admin.toggle(),1000);
